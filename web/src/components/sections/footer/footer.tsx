...
export const Footer: FC = () => {
    return (
        <div className="w-full flex bg-white justify-center items-center p-6 mt-2 border-2 border-solid border-t-neutral-300 border-r-0 border-l-0 border-b-0 mt-auto">
